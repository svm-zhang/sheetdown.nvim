...
--
-- The parser accepts either names or indexes, so the fallback UI can remain
-- identical to the v0.1.x flow.
...
---Collect table options through the original v0.1.x prompt flow.
