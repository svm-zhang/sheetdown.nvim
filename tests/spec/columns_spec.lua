...
return {
  {
    ...
    run = function()
      local parsed = assert(columns.parse_expression("city,name", { "name", "age", "city" }))
  ...
  },
  {
    ...
    run = function()
      local parsed = assert(columns.parse_expression("2,1", { "name", "age", "city" }))
  ...
  },
  {
    ...
    run = function()
      local parsed, err = columns.parse_expression("1,name", { "name", "age" })
